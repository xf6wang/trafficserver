...
import os
Test.Summary = '''
Tests that different command line tools can be used to interface with traffic_manager and traffic_server
'''
...
tr = Test.AddTestRun()
tr.Processes.Default.Command = 'traffic_ctl metric get proxy.node.cache_hit_ratio'
tr.Processes.Default.ReturnCode = 0
tr.Processes.Default.Env = ts.Env
